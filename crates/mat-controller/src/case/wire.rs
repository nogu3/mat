...
mod tests {
    ...
    #[test]
    fn encode_sigma1_golden_bytes() {
        let random = [0x11u8; 32];
        let mut eph_pub = [0x33u8; 65];
        eph_pub[0] = 0x04;
        let out = encode_sigma1(&random, 0x1234, &[0x22u8; 32], &eph_pub);
        assert_eq!(out[0], 0x15);
        assert_eq!(&out[1..4], [0x30, 0x01, 0x20]);
        assert_eq!(*out.last().unwrap(), 0x18);
        assert_eq!(
            out,
            vec![
                0x15, 0x30, 0x01, 0x20, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
                0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
                0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x25, 0x02, 0x34, 0x12, 0x30, 0x03,
                0x20, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22,
                0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22,
                0x22, 0x22, 0x22, 0x22, 0x22, 0x30, 0x04, 0x41, 0x04, 0x33, 0x33, 0x33, 0x33, 0x33,
    ...
    #[test]
    fn encode_tbs_golden_bytes() {
        let noc = [0xAAu8; 3];
        let icac = [0xBBu8; 2];
        let mut sender = [0x44u8; 65];
        sender[0] = 0x04;
        let mut receiver = [0x55u8; 65];
        receiver[0] = 0x04;
        let with_icac = encode_tbs(&noc, Some(&icac), &sender, &receiver);
        assert_eq!(
            with_icac,
            vec![
                ,
            ]
        );
        let without_icac = encode_tbs(&noc, None, &sender, &receiver);
        assert_eq!(
            without_icac,
            vec![
                ,
