...
> **Status: ✅ COMPLETE（v0.7.0 で main にマージ済み）.** 全タスク実装・実機 E2E 検証済み（jarvis node 5）。Issue #2 クローズ済み。
...
- [x] **Step 2: ディスパッチと matd_client を追従**
