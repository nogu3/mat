...
- [x] 既存グループ（controller 側に bind 残存）に対し `mat group provision
      --rebind` が一発で成功する（2026-07-09 jarvis 実機 E2E: group 10/keyset 60/
      7 台、直経路・matd 経路とも一発成功、toggle 読み返しで 7/7 配達確認）
